...
% Global list spacing
\setlist[itemize]{itemsep=4pt, parsep=2pt, topsep=6pt}
\setlist[enumerate]{itemsep=4pt, parsep=2pt, topsep=6pt}

% Boxed definition environment (matching reference style)
\newmdenv[
  linewidth=1.5pt,
  linecolor=black,
  innertopmargin=10pt,
...
\newenvironment{definition}[1][]{%
  ...
  \begin{defbox}%
  \textbf{\textit{Definition~\thedefinition\ifx&#1&\else\space (#1)\fi}}\\[6pt]%
}{%
  \end{defbox}%
}
...
\newenvironment{theorem}[1][]{%
  ...
  \begin{defbox}%
  \textbf{\textit{Theorem~\thetheorem\ifx&#1&\else\space (#1)\fi}}\\[6pt]%
}{%
  \end{defbox}%
}
...
\textbf{Notes on Probability Theory for FinTech} \\
\textbf{DATA 5690-6690: Computational Methods for FinTech} \\
